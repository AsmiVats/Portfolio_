  ...
  return (
    <div className="bg-[#4c6ee2] w-full flex justify-end items-center p-4">
      <div className="flex items-center space-x-4 mr-6">
        <div className="text-white text-lg font-semibold font-['Degular Display']">Portfolio</div>
        <div className="text-white text-lg font-semibold font-['Degular Display']">Services</div>
        <div className="text-[#d3f86e] text-lg font-semibold font-['Degular Display']">About</div>
      </div>
